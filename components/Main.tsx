  ...
  return (
    ...
    {/* Box for Buttons and Heading (Right side) */}
        <div className="w-full lg:w-1/2 p-4 flex text-center flex-col justify-center items-center lg:mr-8">
            ...
            <button className="bg-purple-400 font-syne font-semibold text-lg capitalize flex justify-center items-center gap-4 md:w-[411.104px] w-[334px] py-[18.271px] px-[36.543px] rounded-[45.678px] text-white ">Connect With Wallet</button>
